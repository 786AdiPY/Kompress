...
from kompress.engine.common import build_request_model, records_to_array  # noqa: E402
from kompress.engine.common import onnx_utils                              # noqa: E402
...
def _load_variant(variant, manifest):
    ...
    if kind == "native":
        from kompress.engine.adapters import load_model
