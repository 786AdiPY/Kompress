#!/usr/bin/env python3
"""Standalone empirical benchmark script for ONNX INT8 Dynamic ResNet-50 model."""
import json
import os
import time
import numpy as np
...
MODEL_PATH = os.path.abspath("api_runs/4886d76b30e64e9a93988eb19d07e132/artifacts/ResNet-50 ImageNet Benchmark/model_int8_dynamic.onnx")
